...
class Application(object):
    ...
    def get_information(self):
        ...
        self.intermediate_txt = open('../Programfiles/Intermediates/intermediate.txt','a')
    ...
    def convert_to_pdf(self):
        ...
        self.text_file = open("../Programfiles/Finaltexts/final_text.txt", "r")  # text file I need to convert
...
def main():
    ...
    # else:
    #     print("There is no category",genre)
    #     option = input("Reload? (Y/N): ").upper()
    ...
    print("\n")
    new_user = Application(internal_file,main_character,character1,character2)
    return
main()
